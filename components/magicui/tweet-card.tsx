...
export const TweetSkeleton = ({ className, ...props }: { className?: string }) => (
  <div
    className={cn(
...
export const TweetNotFound = ({ className, ...props }: { className?: string }) => (
  <div
    className={cn(
